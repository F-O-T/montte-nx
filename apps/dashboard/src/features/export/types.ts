...
export const EXPORT_FORMATS: { id: ExportFormat; name: string; description: string }[] = [
	{ id: "ofx", name: "OFX", description: "Open Financial Exchange - compatível com softwares financeiros" },
	{ id: "csv", name: "CSV", description: "Planilha - compatível com Excel e Google Sheets" },
	{ id: "pdf", name: "PDF", description: "Documento - ideal para impressão e arquivamento" },
];
