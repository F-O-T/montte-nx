...
function CostCenterChartsErrorFallback(props: FallbackProps) {
   return (
      <div className="grid gap-4 h-min">
         {createErrorFallback({
            errorDescription:
               "Falha ao carregar graficos do centro de custo. Por favor, tente novamente.",
...
function CostCenterChartsSkeleton() {
   return (
