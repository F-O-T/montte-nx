...
export function ManageInterestTemplateForm({
					...
					<form.Field name="penaltyType">
						{(field) => (
							<Field>
								...
								<Select
									onValueChange={(value) =>
										field.handleChange(value as "none" | "percentage" | "fixed")
									}
									value={field.state.value}
								>
									<SelectTrigger>
									...
									{(field) => (
										<Field>
											...
											<Input
												...
												onChange={(e) => field.handleChange(e.target.value)}
												placeholder={
													penaltyType === "percentage" ? "2.00" : "100.00"
												}
												type="number"
												value={field.state.value}
											/>
					...
					<form.Field name="interestType">
						{(field) => (
							<Field>
								...
								<Select
									onValueChange={(value) =>
										field.handleChange(value as "none" | "daily" | "monthly")
									}
									value={field.state.value}
								>
									<SelectTrigger>
					...
					<form.Field name="monetaryCorrectionIndex">
						{(field) => (
							<Field>
								...
								<Select
									onValueChange={(value) =>
										field.handleChange(value as "none" | "ipca" | "selic" | "cdi")
									}
									value={field.state.value}
								>
									<SelectTrigger>
	...
	return (
		<Stepper.Provider className="h-full" initialStep="basic-info" variant="line">
			{({ methods }) => (
				<form
