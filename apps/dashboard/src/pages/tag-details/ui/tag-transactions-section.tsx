...
function TagTransactionsSkeleton() {
   return (
      <Card>
...
function TagTransactionsContent({
   tagId,
   startDate,
   endDate,
}: {
...
export function TagTransactions({
   ...
   return (
      <ErrorBoundary FallbackComponent={TagTransactionsErrorFallback}>
         <Suspense fallback={<TagTransactionsSkeleton />}>
            <TagTransactionsContent
               endDate={endDate}
               startDate={startDate}
               tagId={tagId}
            />
