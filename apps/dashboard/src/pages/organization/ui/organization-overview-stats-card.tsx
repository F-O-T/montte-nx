				...
				<div className="grid grid-cols-2 md:grid-cols-4 gap-4">
					...
					<Card className="bg-muted/50">
						<CardHeader className="pb-2">
							<div className="flex items-center gap-2">
								...
								<CardDescription>
									{translate("dashboard.routes.organization.stats-card.admins")}
								</CardDescription>
							</div>
					...
					<Card className="bg-muted/50">
						<CardHeader className="pb-2">
							<div className="flex items-center gap-2">
								...
								<CardDescription>
									{translate("dashboard.routes.organization.stats-card.teams")}
								</CardDescription>
							</div>
					...
					<Card className="bg-muted/50">
						<CardHeader className="pb-2">
							...
							<CardTitle className="text-xl">{pendingInvites.length}</CardTitle>
						</CardHeader>
					</Card>
				</div>
			</CardContent>
