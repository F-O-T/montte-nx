...
function HomePageErrorFallback(props: FallbackProps) {
	return createErrorFallback({
		errorDescription: "Failed to load financial overview. Please try again later.",
...
function HomePageContent() {
	...
	return (
		<div className="space-y-6">
			...
			<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
				<StatsCard
					title={translate("dashboard.routes.home.financial-summary.total-income.title")}
					value={`R$ ${summary.totalIncome.toFixed(2)}`}
					description={translate("dashboard.routes.home.financial-summary.total-income.description")}
				/>
				<StatsCard
					title={translate("dashboard.routes.home.financial-summary.total-expenses.title")}
					value={`R$ ${summary.totalExpenses.toFixed(2)}`}
					description={translate("dashboard.routes.home.financial-summary.total-expenses.description")}
				/>
				<StatsCard
					title={translate("dashboard.routes.home.financial-summary.net-balance.title")}
					value={`R$ ${summary.netBalance.toFixed(2)}`}
					description={translate("dashboard.routes.home.financial-summary.net-balance.description")}
				/>
				<StatsCard
					title={translate("dashboard.routes.home.financial-summary.payment-rate.title")}
			...
			<FinancialSummaryChart
				data={cashFlow}
				title={translate("dashboard.routes.home.charts.financial-evolution.title")}
				description={translate("dashboard.routes.home.charts.financial-evolution.description")}
			/>
			...
			<div className="grid gap-4 md:grid-cols-2">
				<CashFlowChart
					...
					description={translate("dashboard.routes.home.charts.cash-flow.description")}
				/>
				<PlannedVsActualChart
					data={plannedVsActual}
					title={translate("dashboard.routes.home.charts.planned-vs-actual.title")}
					description={translate("dashboard.routes.home.charts.planned-vs-actual.description")}
				/>
			</div>
		</div>
	);
