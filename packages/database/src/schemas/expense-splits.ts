...
export const expenseSplitSettlement = pgTable(
	...
	(table) => [
		index("expense_split_settlement_participant_id_idx").on(table.participantId),
	],
);

// Relations
export const expenseSplitRelations = relations(expenseSplit, ({ one, many }) => ({
...
export type ExpenseSplitParticipant = typeof expenseSplitParticipant.$inferSelect;
export type NewExpenseSplitParticipant = typeof expenseSplitParticipant.$inferInsert;
export type ExpenseSplitSettlement = typeof expenseSplitSettlement.$inferSelect;
export type NewExpenseSplitSettlement = typeof expenseSplitSettlement.$inferInsert;
