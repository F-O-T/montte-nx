...
export default function OrganizationInvitationEmail({
	...
	return (
		<DefaultEmailLayout preview={`${invitedByUsername} convidou você para ${teamName}`}>
			<DefaultHeading />
			<Section style={{ padding: "32px 24px", textAlign: "center" }}>
				...
				>
					<strong style={{ color: "#1a1a2e" }}>{invitedByUsername}</strong> está
					convidando você para colaborar na organização{" "}
					<strong style={{ color: "#1a1a2e" }}>{teamName}</strong> no Montte.
				</Text>
				...
				>
					...
					>
						• Visualizar transações e contas compartilhadas<br />
						• Acompanhar orçamentos e metas financeiras<br />
						• Colaborar com a equipe em tempo real
					</Text>
